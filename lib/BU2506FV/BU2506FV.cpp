...
BU2506FV::BU2506FV() { resetChannelValues(); }
...
void BU2506FV::fastWriteA(uint16_t value) { transfer(0x3000 | value); }

void BU2506FV::fastWriteB(uint16_t value) { transfer(0xB000 | value); }
...
float BU2506FV::getPercentage(uint8_t channel) { return (_value[channel] * 100.0) / _maxValue; }

...
bool PCA9555::begin(byte SDAPin, byte SCLPin) {
    if (_interruptPin >= 0) {
        Serial.println("Interrupt pin set to " + String(_interruptPin));
 ...
 *    400000, fast mode
 */
void PCA9555::setClock(uint32_t clockFrequency) { Wire.setClock(clockFrequency); }

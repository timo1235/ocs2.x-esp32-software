...
## latest
## 1.1.5
- Added possibility to connect to a wifi network in station mode. Credentials can be configured in the webinterface. Take a look in your router for the IP of the esp32. Alternatively use the Serial Monitor and look out for the esp32 ip. Thx to @IggePop
